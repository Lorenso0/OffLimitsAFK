...
python -m PyInstaller --noconfirm --onefile --windowed --name "OffLimitsAFK" --distpath . --icon "build_resources\appicon.ico" --add-data "build_resources;resources" main.py
if errorlevel 1 goto :cleanup_fail
